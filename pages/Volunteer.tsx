       ...
       <div className="max-w-container mx-auto px-4 md:px-0">
           ...
           <div className="max-w-2xl mx-auto bg-gray-50 p-8 rounded shadow-sm border border-gray-100">
               <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                   ...
                   <div>
                       <label className="block text-sm font-bold text-gray-700 mb-2">电子邮箱 <span className="text-red-500">*</span></label>
                       <input 
                         {...register("email")}
                         type="email" 
                   ...
                   <div>
                       <label className="block text-sm font-bold text-gray-700 mb-2">所在区域 <span className="text-red-500">*</span></label>
                       <select 
                         {...register("area")}
                   ...
                   <div>
                       <label className="block text-sm font-bold text-gray-700 mb-2">志愿服务意向 (至少选一项) <span className="text-red-500">*</span></label>
                   ...
                   <div>
                       <label className="block text-sm font-bold text-gray-700 mb-2">个人简介 / 技能特长 <span className="text-red-500">*</span></label>
                       <textarea 
                         {...register("bio")}
