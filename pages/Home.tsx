        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-[2]">
            <div className="flex items-center justify-between border-b-2 border-borderGray mb-6">
              <h2 className="text-2xl font-bold text-textMain pb-2 border-b-4 border-primary">慈善新闻</h2>
              <div className="flex gap-4">
                {['news', 'media', 'district'].map((tab) => (
                    <button 
                      key={tab}
                      onClick={() => setActiveNewsTab(tab as any)}
                      className={`px-4 py-1 rounded-full text-sm transition-all ${activeNewsTab === tab ? 'bg-primary text-white shadow-md transform scale-105' : 'bg-white text-textSub hover:bg-gray-100'}`}
                    >
