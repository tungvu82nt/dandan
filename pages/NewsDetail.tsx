    ...
    <div className="bg-white py-8 min-h-screen">
       ...
       <div className="max-w-container mx-auto px-4 md:px-0">
            ...
            <div className="text-sm text-gray-500 mb-6 border-b border-gray-100 pb-2">
                ...
                <Link to="/news" className="hover:text-primary"> 新闻中心</Link> &gt; 
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="prose max-w-none text-lg leading-loose text-gray-700">
                    ...
                    {news.image && (
                        <div className="my-6 text-center">
                            <img src={news.image} alt={news.title} className="max-w-full h-auto mx-auto rounded shadow" />
                ...
                <div className="mt-12 pt-6 border-t border-gray-200 flex justify-between">
                    <Link to="/news" className="text-gray-600 hover:text-primary"> &lt; 返回列表</Link>
