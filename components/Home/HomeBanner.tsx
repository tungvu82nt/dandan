...
export const HomeBanner: React.FC = () => {
  ...
  return (
    <div className="max-w-container mx-auto">
      <div className="relative h-[400px] w-full bg-gray-200 overflow-hidden group">
         <div 
           ...
           {banners.map((_, index) => (
             <button 
               ...
               className={`w-3 h-3 rounded-full cursor-pointer transition-all duration-300 ${
                 currentSlide === index ? 'bg-primary ring-2 ring-white scale-110' : 'bg-white/50 hover:bg-white'
               }`}
