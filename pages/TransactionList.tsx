          ...
          <div className="space-y-4 text-sm text-gray-600">
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div className="flex gap-2 md:ml-4">
                 <button className="hover:text-primary hover:bg-gray-100 px-2 py-1 rounded" onClick={() => {setStartDate(''); setEndDate('');}}>清除日期</button>
              </div>
            </div>
            ...
            <tbody>
              {filteredData.length > 0 ? filteredData.map((d) => (
                <tr key={d.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3 border-b font-bold text-accent">￥{d.amount.toFixed(2)}</td>
                ...
                <tr>
                  <td colSpan={6} className="text-center py-10 text-gray-400">没有找到匹配的记录</td>
                </tr>
              )}
            </tbody>
          </table>
